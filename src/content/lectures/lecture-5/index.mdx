...
**Figure 1 - One-at-a-time sensitivity of the Nes et al. (2011) VO₂max estimate, shown against the ±1 SEE and ±1.96 SEE prediction bands.**
</Figure>
...
**Figure 2 - Male vs. female VO₂max equation applied to one identical input profile; bars and SEE bands in greyscale.**
</Figure>
...
**Figure 2 - Person comparison of Example 2 (fit young female) and Example 3 (inactive older male), each with own profile and equation.**
</Figure>
