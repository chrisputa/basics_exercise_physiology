...
and proposed a slightly revised coefficient set (370 + 21.6 × FFM), along with a weight-based
alternative equation for situations where body composition data are unavailable [20]. For athletic
populations — including strength-trained and endurance athletes — equations incorporating
fat-free mass (FFM) are generally preferred, as FFM is the primary determinant of resting
metabolic rate.
...
*Table 2. Overview of commonly used BMR/RMR prediction equations with special relevance for athletic
populations (adapted from [17–20]).*
