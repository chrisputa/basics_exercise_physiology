---
title: Basics Exercise Physiology and Immunology - Key Concepts, Homeostasis and Hormesis
...
import fig1 from '../../../assets/figure1_homeostasis_timecourse_bw.png';
import fig1Dark from '../../../assets/generated/figure1_homeostasis_timecourse_bw_dark.png';
import fig2 from '../../../assets/figure2_hormesis_doseresponse_bw.png';
import fig2Dark from '../../../assets/generated/figure2_hormesis_doseresponse_bw_dark.png';
...
<Figure src={fig1} srcDark={fig1Dark} alt="Homeostasis time-course">
**Figure 1 — Homeostasis time-course: the IL-6 peak, delayed IL-10/IL-1Ra counter-response, functional capacity dip, and the set-point reference line, with annotated phase zones.**
</Figure>

<Figure src={fig1} srcDark={fig1Dark} alt="Hormesis dose-response">
**Figure 2 — Hormesis dose-response: the full J-curve (URTI risk), bell-shaped adaptive benefit, and monotonically rising inflammatory load, with the three dose zones (sub-threshold / hormetic / overload) shaded.**
</Figure>
